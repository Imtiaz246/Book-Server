...
func RestoreDataFromBackupFiles() ([]byte, []byte, error) {
	// Restore User data
	uf, err := os.Open("/home/appscode-pc-a1-11/Documents/BookServer/BackupFiles/Users.json")
	if err != nil {
		return nil, nil, err
	}
	defer uf.Close()
	...
	// Restore Book data
	bf, err := os.Open("/home/appscode-pc-a1-11/Documents/BookServer/BackupFiles/Books.json")
	if err != nil {
		return nil, nil, err
	}
	defer bf.Close()
